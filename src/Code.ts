...
function getResume() {
  ...
  * {
  ...
  <ul>
    <li><a href="https://drive.google.com/drive/folders/${folderId}" target="_blank" rel="noopener noreferrer">Resumer folder</a>
    </li>
    <ul>
...
function addResume(resume: string, coverLetter: string) {
  const resumeSheet =
    SpreadsheetApp.getActive().getSheetByName("Resume - Generated");
